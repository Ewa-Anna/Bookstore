...
class Profile(models.Model):
    ...
    shipping_address = models.OneToOneField(
        'ShippingAddress', on_delete=models.SET_NULL, null=True, blank=True, related_name='profile'
    )
    ...
    def calculate_age(self):
        if self.date_of_birth:
            ...
            if today.day < birth_day:
                days_in_previous_month = (today - date(today.year, (today.month - 1 if today.month > 1 else 12), 1)).days
